...
| Symbol | Kind | Lines | Declaration, inputs, and outputs | Source description |
|---|---|---:|---|---|
| [`RunSearchTerm`](../src/database/term_matches.go#L13) | struct | 13-19 | ``type RunSearchTerm struct { ID int64 `json:"id"` PipelineRunID int64 `json:"pipeline_run_id"` SourceName string `json:"source_name"` Term string `json:"term"` CreatedAt string `json:"created_at"` }`` | RunSearchTerm is one stored search term and the source that declared it. |
| [`TermMatchesRepository`](../src/database/term_matches.go#L23) | struct | 23-25 | `type TermMatchesRepository struct { db *Database }` | TermMatchesRepository provides replace and read access to the derived run_search_terms and work_revision_term_matches tables. |
| [`(*TermMatchesRepository).ReplaceRunTerms`](../src/database/term_matches.go#L29) | method | 29-33 | `func (*TermMatchesRepository).ReplaceRunTerms(runID int64, termsBySource map[string][]string) error` | ReplaceRunTerms replaces the parsed term inventory for one run in a single transaction. It is safe to call twice for the same run. |
| [`(*TermMatchesRepository).ReplaceRunMatches`](../src/database/term_matches.go#L37) | method | 37-41 | `func (*TermMatchesRepository).ReplaceRunMatches(runID int64, matches map[int64]map[string][]string) error` | ReplaceRunMatches replaces the per-revision field matches for one run in a single transaction. It is safe to call twice for the same run. |
| [`(*TermMatchesRepository).ReplaceRunTermData`](../src/database/term_matches.go#L45) | method | 45-52 | `func (*TermMatchesRepository).ReplaceRunTermData(runID int64, termsBySource map[string][]string, matches map[int64]map[string][]string) error` | ReplaceRunTermData replaces both the term inventory and the revision matches for one run in a single transaction, preserving per-run atomicity. |
| [`(*TermMatchesRepository).CountRunTermData`](../src/database/term_matches.go#L56) | method | 56-64 | `func (*TermMatchesRepository).CountRunTermData(runID int64) (int64, error)` | CountRunTermData returns the number of stored match rows for one run. It is used by the reconciliation pass to skip runs that already have term data. |
| [`(*TermMatchesRepository).GetRunTerms`](../src/database/term_matches.go#L67) | method | 67-87 | `func (*TermMatchesRepository).GetRunTerms(runID int64) ([]RunSearchTerm, error)` | GetRunTerms returns the stored term inventory for one run ordered by id. |
| [`(*TermMatchesRepository).GetRevisionMatches`](../src/database/term_matches.go#L90) | method | 90-99 | `func (*TermMatchesRepository).GetRevisionMatches(runID, revisionID int64) (map[string][]string, error)` | GetRevisionMatches returns the per-field matched terms for one revision. |
| [`(*TermMatchesRepository).GetRevisionMatchesBulk`](../src/database/term_matches.go#L103) | method | 103-136 | `func (*TermMatchesRepository).GetRevisionMatchesBulk(runID int64, revisionIDs []int64) (map[int64]map[string][]string, error)` | GetRevisionMatchesBulk returns per-field matched terms for a page of revisions. It short-circuits when the revision list is empty. |
| [`(*TermMatchesRepository).replaceRunTermsTx`](../src/database/term_matches.go#L139) | method | 139-153 | `func (*TermMatchesRepository).replaceRunTermsTx(tx *sql.Tx, runID int64, termsBySource map[string][]string) error` | replaceRunTermsTx deletes and reinserts the term inventory for one run. |
| [`(*TermMatchesRepository).replaceRunMatchesTx`](../src/database/term_matches.go#L156) | method | 156-172 | `func (*TermMatchesRepository).replaceRunMatchesTx(tx *sql.Tx, runID int64, matches map[int64]map[string][]string) error` | replaceRunMatchesTx deletes and reinserts the revision matches for one run. |
| [`scanMatches`](../src/database/term_matches.go#L175) | function | 175-188 | `func scanMatches(rows *sql.Rows) (map[string][]string, error)` | scanMatches groups (field, term) rows into per-field term lists. |
...
| [`APIError.constructor`](../frontend/src/api.tsx#L39) | method | 39 | `constructor(message: string, status: number, code?: string, details?: any)` | Initializes one structured API error returned by a non-successful response. |
| [`api`](../frontend/src/api.tsx#L50) | function | 50 | `async function api(path: string, query: Record<string, any> = {}, options: APIRequestOptions)` | Fetches and decodes one JSON API response. |
...
| [`tables`](../frontend/src/api.tsx#L84) | function | 84 | `async function tables()` | Loads and caches the discovered database table list. |
...
| [`bindFocusContext`](../frontend/src/router.tsx#L27) | function | 27 | `function bindFocusContext()` | Binds DOM behavior for focus context. |
| [`syncPrimaryNavigation`](../frontend/src/router.tsx#L37) | function | 37 | `function syncPrimaryNavigation(current: string)` | Synchronizes primary navigation. |
| [`syncShell`](../frontend/src/router.tsx#L55) | function | 55 | `function syncShell(current: string)` | Synchronizes shell visibility and the page-level breadcrumb before a view renders. |
| [`renderView`](../frontend/src/router.tsx#L82) | function | 82 | `async function renderView()` | Asynchronously renders view. |
| [`render`](../frontend/src/router.tsx#L97) | function | 97 | `async function render()` | Asynchronously renders the associated state. |
...
| [`formatDuration`](../frontend/src/state.tsx#L169) | function | 169 | `function formatDuration(startedAt: any, finishedAt: any)` | Formats the elapsed time between two recorded timestamps. |
| [`formatBytes`](../frontend/src/state.tsx#L187) | function | 187 | `function formatBytes(raw: any)` | Formats bytes. |
| [`humanLabel`](../frontend/src/state.tsx#L203) | function | 203 | `function humanLabel(raw: any)` | Converts a machine-oriented identifier to a title-cased display label. |
| [`parseObject`](../frontend/src/state.tsx#L212) | function | 212 | `function parseObject(raw: any)` | Parses object. |
| [`statusClass`](../frontend/src/state.tsx#L231) | function | 231 | `function statusClass(raw: any)` | Maps a recorded status to its semantic color class. |
| [`StatusChip`](../frontend/src/state.tsx#L249) | function | 249 | `function StatusChip(props: { raw: any })` | Renders one status chip with its semantic color class. |
| [`statusChip`](../frontend/src/state.tsx#L254) | function | 254 | `function statusChip(raw: any)` | Returns escaped label markup for a recorded status. |
| [`metricEntries`](../frontend/src/state.tsx#L259) | function | 259 | `function metricEntries(group: any)` | Normalizes array- or object-backed metrics to display-name and value pairs. |
| [`selectedRun`](../frontend/src/state.tsx#L270) | function | 270 | `function selectedRun()` | Returns the pipeline run selected by the current URL context. |
| [`showError`](../frontend/src/state.tsx#L278) | function | 278 | `function showError(error: any)` | Shows error. |
| [`clearError`](../frontend/src/state.tsx#L284) | function | 284 | `function clearError()` | Clears error. |
| [`busy`](../frontend/src/state.tsx#L290) | function | 290 | `function busy(isBusy: boolean)` | Shows or hides the global loading indicator. |
| [`link`](../frontend/src/state.tsx#L295) | function | 295 | `function link(updates?: Record<string, any>)` | Builds an internal URL that preserves current research context and applies supplied updates. |
| [`PageHeader`](../frontend/src/state.tsx#L314) | function | 314 | `function PageHeader(props: { kicker: string; title: string; description: string; extra?: string })` | Renders the standard page header with escaped copy and optional actions. |
| [`pageHeader`](../frontend/src/state.tsx#L328) | function | 328 | `function pageHeader(kicker: string, title: string, description: string, extra?: string)` | Returns the standard page header with escaped copy and optional actions. |
...
| [`Subnav`](../frontend/src/state.tsx#L453) | function | 453 | `function Subnav(props: { items: Array<[string, string]>; current: string; key: string })` | Renders context-preserving tab navigation for a keyed section. |
| [`subnav`](../frontend/src/state.tsx#L463) | function | 463 | `function subnav(items: Array<[string, string]>, current: string, key: string)` | Returns context-preserving tab navigation for a keyed section. |
| [`FilterChips`](../frontend/src/state.tsx#L474) | function | 474 | `function FilterChips(props: { filters: Record<string, any> \| null; labels?: Record<string, string>; options?: FilterChipOptions })` | Renders removable filter chips with a clear-all action. |
| [`filterChips`](../frontend/src/state.tsx#L504) | function | 504 | `function filterChips(filters: Record<string, any> \| null, labels?: Record<string, string>, options?: FilterChipOptions)` | Filters chips. |
| [`MetricCard`](../frontend/src/state.tsx#L509) | function | 509 | `function MetricCard(props: { name: string; metric: any; href?: string })` | Renders a metric card with availability, denominator, and optional navigation. |
| [`metricCard`](../frontend/src/state.tsx#L544) | function | 544 | `function metricCard(name: string, metric: any, href?: string)` | Returns a metric card with availability, denominator, and optional navigation. |
...
| Symbol | Kind | Lines | Declaration, inputs, and outputs | Source description |
|---|---|---:|---|---|
| [`columnNames`](../frontend/src/views/corpus.tsx#L83) | function | 83 | `function columnNames(table: any)` | Returns the ordered union of column names present in result rows. |
| [`IdentityEvidenceTable`](../frontend/src/views/corpus.tsx#L96) | function | 96 | `function IdentityEvidenceTable(props: { data: any; context: DataTableContext & { perPage: number } })` | Renders the column definition used for identity evidence rows. |
| [`clippedRecordLink`](../frontend/src/views/corpus.tsx#L164) | function | 164 | `function clippedRecordLink(kind: string, idKey: string, id: any, title: any)` | Renders a context-preserving record link with a clipped label. |
| [`clippedRecordText`](../frontend/src/views/corpus.tsx#L171) | function | 171 | `function clippedRecordText(title: any)` | Renders escaped record text clipped to the requested length. |
| [`termMatchMarkup`](../frontend/src/views/corpus.tsx#L176) | function | 176 | `function termMatchMarkup(row: any)` | Renders the stored search-term coverage for one article row. |
| [`corpusColumnConfig`](../frontend/src/views/corpus.tsx#L210) | function | 210 | `function corpusColumnConfig(current: string)` | Returns section-specific labels and renderers for corpus columns. |
| [`corpusView`](../frontend/src/views/corpus.tsx#L265) | function | 265 | `async function corpusView()` | Asynchronously implements corpus view for the viewer. |
...
| [`SearchTermCoveragePanel`](../frontend/src/views/detail.tsx#L272) | function | 272 | `function SearchTermCoveragePanel(props: { matches: any; record: any })` | Renders the search term coverage panel for an article revision. |
| [`ArticleView`](../frontend/src/views/detail.tsx#L340) | function | 340 | `function ArticleView(props: { record: any; data: any })` | Renders the article detail view from its immutable revision payload. |
| [`PDFStatusPanel`](../frontend/src/views/detail.tsx#L415) | function | 415 | `function PDFStatusPanel(props: { record: any; pdf: any })` | Renders PDF inventory and download-status markup for an article. |
| [`AuthorIdentityEvidence`](../frontend/src/views/detail.tsx#L439) | function | 439 | `function AuthorIdentityEvidence(props: { data: any })` | Renders candidate ORCID evidence associated with the selected author occurrence. |
| [`AuthorView`](../frontend/src/views/detail.tsx#L460) | function | 460 | `function AuthorView(props: { record: any; data: any })` | Renders the author occurrence detail view with related articles and audit evidence. |
| [`ReferenceView`](../frontend/src/views/detail.tsx#L493) | function | 493 | `function ReferenceView(props: { record: any })` | Renders the reference mention detail view with citation context. |
| [`detailView`](../frontend/src/views/detail.tsx#L529) | function | 529 | `async function detailView(kind: string)` | Asynchronously implements detail view for the viewer. |
...
| [`renders no search terms recorded when term_matches is null`](../frontend/tests/unit/views/detail.test.ts#L250) | test | 250 | `it('renders no search terms recorded when term_matches is null', callback)` | renders no search terms recorded when term_matches is null |
| [`renders reference detail when reference_id is set`](../frontend/tests/unit/views/detail.test.ts#L287) | test | 287 | `it('renders reference detail when reference_id is set', callback)` | renders reference detail when reference_id is set |
