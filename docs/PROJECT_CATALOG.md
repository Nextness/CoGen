...
| [`TestTokenizeAt`](../src/something/lexer_unit_test.go#L384) | test | 384-387 | `func TestTokenizeAt(t *testing.T)` | TestTokenizeAt verifies the '@' intrinsic prefix tokenizes as TkAT. |
| [`TestParseFallbackChar`](../src/something/lexer_unit_test.go#L390) | test | 390-393 | `func TestParseFallbackChar(t *testing.T)` | TestParseFallbackChar verifies parse fallback char. |
| [`TestEvalStringLiteralRef`](../src/something/lexer_unit_test.go#L396) | test | 396-403 | `func TestEvalStringLiteralRef(t *testing.T)` | TestEvalStringLiteralRef verifies eval string literal ref. |
| [`TestLexerFallbackChar`](../src/something/lexer_unit_test.go#L406) | test | 406-436 | `func TestLexerFallbackChar(t *testing.T)` | TestLexerFallbackChar verifies lexer fallback char. |
