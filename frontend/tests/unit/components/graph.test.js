...
import '../setup.js';
import { graphField, graphQuery, graphLink, graphResult, graphClusters, zoomViewAt, destroyGraph, mountGraph } from '../../../src/components/graph.ts';
...
describe('graph.js — graphLink', function() {
  ...
  it('does not fabricate a detail route for a raw referenced-author string', function() {
    assert.equal(graphLink({ type: 'referenced_author', id: 'raw:1' }), '');
  });
