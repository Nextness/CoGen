...
if (!globalThis.matchMedia) {
  globalThis.matchMedia = function(_query: string) {
    return { matches: false, media: '', onchange: null, addListener: function() {}, removeListener: function() {}, addEventListener: function() {}, removeEventListener: function() {}, dispatchEvent: function() { return false; } };
...
if (!globalThis.AbortController) {
  const StubAbortController = class {
    signal: { aborted: boolean };
    constructor() { this.signal = { aborted: false }; }
    abort() { this.signal.aborted = true; }
  };
  globalThis.AbortController = StubAbortController as unknown as typeof AbortController;
}
